...
# make plot 3 #
plot3 <- plot(Sub_metering_1~datetime, hpc3c, ylab = "Energy sub metering", type = "l", xlab = '', bg="white" )
          lines(Sub_metering_2~datetime, hpc3c, type = "l", col = "red")
          lines(Sub_metering_3~datetime, hpc3c, type = "l", col = "blue")
          legend("topright", bg="transparent", bty = "n", pch = "-", col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), )
