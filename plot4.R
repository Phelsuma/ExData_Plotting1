...
par(mfcol = c(2,2), bg="white", oma=c(0,0,2,0), mar=c(4,4,2,1))
...
legend("topright", bg="transparent", cex = 0.5, bty = "n", pch = "-", col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), )
